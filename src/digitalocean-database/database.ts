...
import { DigitalOceanEntity, DigitalOceanEntityDefinition, DigitalOceanEntityState } from "./digitalocean-base.ts";
import { 
    DatabaseEngine, 
    DatabaseRegion, 
    DatabaseSize, 
 ...
 */
export interface DigitalOceanDatabaseDefinition extends DigitalOceanEntityDefinition {
    /**
 ...
 */
export interface DigitalOceanDatabaseState extends DigitalOceanEntityState {
    /**
     * Database cluster ID
     */
    id?: string;
 ...
 */
export class DigitalOceanDatabase extends DigitalOceanEntity<
...
> {
    ...
    override update(): void {
        ...
        this.waitForDatabaseStatus(this.state.id!, "online", 60, 10000); // 10 minutes timeout
