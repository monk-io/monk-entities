...
var _Deploy = class _Deploy extends (_a = VercelEntity, _getDeployment_dec = [action("Get deployment details")], _getLogs_dec = [action("Get deployment logs")], _a) {
  constructor() {
    super(...arguments);
  ...
  checkReadiness() {
    ...
    try {
      const deployment = this.makeRequest("GET", `/v13/deployments/${this.state.id}`);
...
__decorateElement(_init, 1, "getDeployment", _getDeployment_dec, _Deploy);
__decorateElement(_init, 1, "getLogs", _getLogs_dec, _Deploy);
