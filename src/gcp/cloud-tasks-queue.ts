    ...
    private buildQueueBody(): Record<string, unknown> {
        ...
        if (this.definition.log_level) {
            body.stackdriverLoggingConfig = {
                samplingRatio: this.definition.log_level === "DEBUG" ? 1.0
                    : this.definition.log_level === "INFO" ? 0.7
                    : this.definition.log_level === "WARNING" ? 0.5
                    : this.definition.log_level === "ERROR" ? 0.3
                    : this.definition.log_level === "CRITICAL" ? 0.1
                    : 1.0,
            };
        }
