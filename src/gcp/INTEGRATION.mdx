...
description: Managed cloud databases and storage (Cloud SQL, Firestore, BigQuery, Cloud Storage).
website_url: https://cloud.google.com/
docs_url: https://cloud.google.com/docs
primary_category: database
tags: [gcp, database, cloud-sql, firestore, bigquery, storage, postgresql, mysql]
