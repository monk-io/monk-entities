...
// input/hetzner-object-storage/bucket.ts
const s3Base = require("hetzner-object-storage/s3-base");
const HetznerS3Entity = s3Base.HetznerS3Entity;
...
var _Bucket = class _Bucket extends (_a = HetznerS3Entity, _getBucketInfo_dec = [action()], _listObjects_dec = [action()], _generatePresignedUrl_dec = [action()], _emptyBucket_dec = [action()], _getBucketStatistics_dec = [action()], _a) {
  constructor() {
    super(...arguments);
  ...
  create() {
    ...
    if (this.bucketExists(bucketName)) {
      ...
      this.state.endpoint = `${this.region}.yourObjectstorage.com`;
...
__decorateElement(_init, 1, "getBucketInfo", _getBucketInfo_dec, _Bucket);
__decorateElement(_init, 1, "listObjects", _listObjects_dec, _Bucket);
__decorateElement(_init, 1, "generatePresignedUrl", _generatePresignedUrl_dec, _Bucket);
__decorateElement(_init, 1, "emptyBucket", _emptyBucket_dec, _Bucket);
__decorateElement(_init, 1, "getBucketStatistics", _getBucketStatistics_dec, _Bucket);
__decoratorMetadata(_init, _Bucket);
...
function main(def, state, ctx) {
  const entity = new Bucket(def, state, ctx);
