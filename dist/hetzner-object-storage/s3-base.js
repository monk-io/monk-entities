...
// input/hetzner-object-storage/s3Base.ts
var s3_base_exports = {};
__export(s3_base_exports, {
  HetznerS3Entity: () => HetznerS3Entity
});
module.exports = __toCommonJS(s3_base_exports);
...
var HetznerS3Entity = class extends import_base.MonkEntity {
  constructor() {
    super(...arguments);
  ...
  getBucketUrl(bucketName, path) {
    ...
    return `https://${bucketName}.${this.region}.yourObjectstorage.com${basePath}`;
  }
  getServiceUrl(path) {
    const basePath = path ? path.startsWith("?") ? path : `/${path}` : "";
    return `https://${this.region}.yourObjectstorage.com${basePath}`;
  }
