...
// input/gcp/identityPlatformDefaultIdpConfig.ts
...
var _IdentityPlatformDefaultIdpConfig = class _IdentityPlatformDefaultIdpConfig extends (_a = GcpEntity, _getInfo_dec = [action("get-info")], _enable_dec = [action("enable")], _disable_dec = [action("disable")], _a) {
  constructor() {
    super(...arguments);
...
__decorateElement(_init, 1, "getInfo", _getInfo_dec, _IdentityPlatformDefaultIdpConfig);
__decorateElement(_init, 1, "enable", _enable_dec, _IdentityPlatformDefaultIdpConfig);
__decorateElement(_init, 1, "disable", _disable_dec, _IdentityPlatformDefaultIdpConfig);
__decoratorMetadata(_init, _IdentityPlatformDefaultIdpConfig);
__name(_IdentityPlatformDefaultIdpConfig, "IdentityPlatformDefaultIdpConfig");
__publicField(_IdentityPlatformDefaultIdpConfig, "readiness", { period: 5, initialDelay: 2, attempts: 10 });
var IdentityPlatformDefaultIdpConfig = _IdentityPlatformDefaultIdpConfig;



function main(def, state, ctx) {
  const entity = new IdentityPlatformDefaultIdpConfig(def, state, ctx);
