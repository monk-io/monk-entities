...
// input/aws-dynamo-db/dynamoDbBase.ts
var dynamo_db_base_exports = {};
__export(dynamo_db_base_exports, {
  AWSDynamoDBEntity: () => AWSDynamoDBEntity,
  action: () => import_base.action
});
module.exports = __toCommonJS(dynamo_db_base_exports);
