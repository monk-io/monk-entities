...
// input/aws-neptune/accessList.ts
...
const getCurrentSecurityGroupRules = common.getCurrentSecurityGroupRules;
const revokeSecurityGroupIngress = common.revokeSecurityGroupIngress;
const updateSecurityGroupRules = common.updateSecurityGroupRules;
const cli = require("cli");
var _NeptuneAccessList = class _NeptuneAccessList extends MonkEntity {
  create() {
...
__name(_NeptuneAccessList, "NeptuneAccessList");
__publicField(_NeptuneAccessList, "readiness", { period: 5, initialDelay: 2, attempts: 20 });
var NeptuneAccessList = _NeptuneAccessList;



function main(def, state, ctx) {
  const entity = new NeptuneAccessList(def, state, ctx);
