...
var DigitalOceanEntity = class extends import_base.MonkEntity {
   ...
   */
  waitForDatabaseStatus(databaseId, targetStatus, maxAttempts = 40, delayMs = 5e3) {
    let attempts = 0;
    ...
    throw new Error(`Database ${databaseId} did not reach ${targetStatus} status within ${maxAttempts * delayMs / 1e3} seconds`);
  }
};
/**
