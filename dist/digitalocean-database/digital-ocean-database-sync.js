...
const digitaloceanBase = require("digitalocean-database/digitalocean-base");
const DigitalOceanEntity = digitaloceanBase.DigitalOceanEntity;
...
var _DigitalOceanDatabase = class _DigitalOceanDatabase extends (_a = DigitalOceanEntity, _getDatabase_dec = [action("getDatabase")], _listDatabases_dec = [action("listDatabases")], _createDatabase_dec = [action("createDatabase")], _deleteDatabase_dec = [action("deleteDatabase")], _getConnectionInfo_dec = [action("getConnectionInfo")], _resizeCluster_dec = [action("resizeCluster")], _a) {
  constructor() {
    super(...arguments);
  ...
  update() {
    ...
    this.waitForDatabaseStatus(this.state.id, "online", 60, 1e4);
    try {
