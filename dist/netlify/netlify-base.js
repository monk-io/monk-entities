...
var NetlifyEntity = class extends import_base.MonkEntity {
  constructor() {
     ...
     */
    __publicField(this, "baseUrl", "https://api.netlify.com/api/v1");
  }
  /**
...
__publicField(NetlifyEntity, "readiness", { period: 15, initialDelay: 2, attempts: 20 });
