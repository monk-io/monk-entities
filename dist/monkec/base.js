...
function unflattenIndexedArrays(value) {
  if (Array.isArray(value)) {
    return value.map((v) => unflattenIndexedArrays(v));
  }
...
var MonkEntity = class _MonkEntity {
  ...
  constructor(definition, state, ctx) {
     ...
     */
    __publicField(this, "rawDefinitionForHash");
    this.rawDefinitionForHash = definition;
    this.definition = unflattenIndexedArrays(definition);
