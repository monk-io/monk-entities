...
// input/clerk/oauthApplication.ts
const clerkBase = require("clerk/clerk-base");
const ClerkEntity = clerkBase.ClerkEntity;
const action = clerkBase.action;
const secret = require("secret");
const cli = require("cli");
var _rotateSecret_dec, _getInfo_dec, _a, _init;
var _OAuthApplication = class _OAuthApplication extends (_a = ClerkEntity, _getInfo_dec = [action("get-info")], _rotateSecret_dec = [action("rotate-secret")], _a) {
  constructor() {
    super(...arguments);
  ...
  create() {
    ...
    if (this.definition.public_client !== void 0) body["public"] = this.definition.public_client;
...
__decorateElement(_init, 1, "getInfo", _getInfo_dec, _OAuthApplication);
__decorateElement(_init, 1, "rotateSecret", _rotateSecret_dec, _OAuthApplication);
__decoratorMetadata(_init, _OAuthApplication);
__name(_OAuthApplication, "OAuthApplication");
var OAuthApplication = _OAuthApplication;



function main(def, state, ctx) {
  const entity = new OAuthApplication(def, state, ctx);
