...
// input/resend/resendBase.ts
var resend_base_exports = {};
__export(resend_base_exports, {
  ResendEntity: () => ResendEntity
});
module.exports = __toCommonJS(resend_base_exports);
...
var ResendEntity = class extends import_base.MonkEntity {
  constructor() {
    super(...arguments);
  ...
  request(method, path, body) {
    ...
    if (!res.ok) {
      throw new Error(
        `Resend API error: ${res.statusCode} ${res.status} - ${typeof res.data === "string" ? res.data : JSON.stringify(res.data)}`
      );
    }
    return res.data;
  }
