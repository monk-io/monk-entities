...
// ../monk-entities/src/auth0/resourceServer.ts
...
const collectArray = common.collectArray;
const cli = require("cli");
var _costs_dec, _getCostEstimate_dec, _getInfo_dec, _a, _init;
var _ResourceServer = class _ResourceServer extends (_a = Auth0Entity, _getInfo_dec = [action("get-info")], _getCostEstimate_dec = [action("get-cost-estimate")], _costs_dec = [action("costs")], _a) {
  constructor() {
    super(...arguments);
  ...
  getCostEstimate(_args) {
    cli.output(
      "Auth0 billing is tenant-wide (MAU-based subscription tier), not attributable to an individual resource server. No per-entity cost estimate is available."
    );
  }
  costs() {
...
__decorateElement(_init, 1, "getInfo", _getInfo_dec, _ResourceServer);
__decorateElement(_init, 1, "getCostEstimate", _getCostEstimate_dec, _ResourceServer);
__decorateElement(_init, 1, "costs", _costs_dec, _ResourceServer);
__decoratorMetadata(_init, _ResourceServer);
__name(_ResourceServer, "ResourceServer");
var ResourceServer = _ResourceServer;



function main(def, state, ctx) {
  const entity = new ResourceServer(def, state, ctx);
