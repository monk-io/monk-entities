...
// input/workos/workosBase.ts
var workos_base_exports = {};
__export(workos_base_exports, {
  WorkOSEntity: () => WorkOSEntity,
  action: () => import_base2.action
});
module.exports = __toCommonJS(workos_base_exports);
...
var WorkOSEntity = class extends import_base.MonkEntity {
  constructor() {
    super(...arguments);
    __publicField(this, "apiKey");
    __publicField(this, "httpClient");
    __publicField(this, "baseUrl", "https://api.workos.com");
  }
  before() {
...
__publicField(WorkOSEntity, "readiness", { period: 10, initialDelay: 1, attempts: 12 });
