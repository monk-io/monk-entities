...
var _Organization = class _Organization extends (_a = WorkOSEntity, _getInfo_dec = [action("get-info")], _getCostEstimate_dec = [action("get-cost-estimate")], _costs_dec = [action("costs")], _a) {
  constructor() {
    super(...arguments);
  ...
  create() {
    ...
    if (this.definition.domains && this.definition.domains.length > 0) {
      body["domains"] = this.definition.domains.map((d) => ({ domain: d, state: "verified" }));
    }
