...
var _Role = class _Role extends (_a = WorkOSEntity, _getInfo_dec = [action("get-info")], _a) {
  constructor() {
    super(...arguments);
  ...
  create() {
    ...
    try {
      ...
      found = items.find((it) => it.slug === this.definition.slug || it.name === this.definition.name);
    } catch {
    }
    if (found) {
      this.state = {
...
__decorateElement(_init, 1, "getInfo", _getInfo_dec, _Role);
