...
modules=(${@:-monkec monk-bridge mongodb-atlas neon netlify vercel aws-dynamo-db aws-s3 aws-sqs aws-iam aws-lambda aws-rds digitalocean-spaces digitalocean-database digitalocean-domains digitalocean-agent digitalocean-container-registry cloudflare aws-api-gateway aws-ec2 aws-cloudfront aws-ses aws-sns aws-neptune aws-glue-schema-registry digitalocean-monitoring stripe azure-cosmosdb azure-storage-account azure-eventhubs azure-servicebus supabase gcp hetzner-dns hetzner-object-storage})
