...
modules=(${@:-monkec monk-bridge mongodb-atlas neon netlify vercel aws-dynamo-db aws-s3 aws-sqs aws-iam aws-lambda aws-rds digitalocean-spaces digitalocean-database digitalocean-domains digitalocean-agent digitalocean-container-registry cloudflare aws-api-gateway aws-ec2 aws-cloudfront aws-ses aws-sns digitalocean-monitoring stripe azure-cosmosdb supabase})
